...
pub enum EventMsg {
    ...
    /// Notification that parallel execution has started
    ParallelExecutionStart(ParallelExecutionStartEvent),

    /// Progress update for parallel execution
    ParallelExecutionProgress(ParallelExecutionProgressEvent),

    /// Notification that parallel execution has ended
    ParallelExecutionEnd(ParallelExecutionEndEvent),
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ParallelExecutionStartEvent {
    /// Unique identifier for this parallel execution group
    pub group_id: String,
    /// List of tool names being executed in parallel
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ParallelExecutionProgressEvent {
    /// Group identifier
    pub group_id: String,
    ...
    pub total: usize,
    /// Name of the tool that just completed (if any)
    pub completed_tool: Option<String>,
}

#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct ParallelExecutionEndEvent {
    /// Group identifier
    pub group_id: String,
