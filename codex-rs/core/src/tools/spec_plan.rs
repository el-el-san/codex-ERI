...
fn append_extension_tool_executors(
    ...
    if matches!(
        ...
        reserved_tool_names.insert(ToolName::plain(codex_tools::CODE_MODE_PUBLIC_TOOL_NAME));
        reserved_tool_names.insert(ToolName::plain(codex_tools::CODE_MODE_WAIT_TOOL_NAME));
    }
